...
class Projects extends BaseController
{
	...
	public function index()
	{
		...
		$per_page = 20;
		// , 'tags', 'p_start_date', 'p_end_date', 'p_status',
		$columns = [
			'p_id',
			['label' => 'Image', 'callback' => 'callback_featured_image', 'search' => 'p_image'], // , 'search_field_type' => 'date'
			'p_uid', 
			'p_title', 
			'p_price', 
			['label' => 'Days left', 'callback' => 'callback_days_left'] // , 'search_field_type' => 'date'
		];
	...
	protected function field_options()
	{
		...
		$fields['p_image'] = [
			...
			'delete_callback' => 'removeFeaturedImage', // remove in db
			'delete_file' => true, // delete from server,
		...
		$fields['project_files'] = [
			...
			'delete_callback' => 'deleteFile', // remove in db
			'delete_file' => true, // delete from server,
			'delete_button_class' => 'btn btn-danger btn-xs'
		];
